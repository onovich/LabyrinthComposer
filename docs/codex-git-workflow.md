...
<!-- initialized-at: 2026-06-15 22:35:27 +08:00 -->
...
```
powershell
git -c safe.directory=D:/LabProjects/LabyrinthComposer status --short --branch
```
...
```
powershell
git -c safe.directory=D:/LabProjects/LabyrinthComposer push -u origin HEAD
```
